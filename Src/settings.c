...
//	}
	int idx = 0;
	systemSettings.ironTips[idx++] = (tipData){"B"		, 1300 , 2100	,2586 , { 0.0015 , 0.002	, 		0, DF_LIMS} };
	...
	systemSettings.ironTips[idx++] = (tipData){"D24"	, 1300 , 2300	,2586 , { 0.003	, 0.003*2	, 		0, DF_LIMS} };
