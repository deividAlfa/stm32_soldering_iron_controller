...
#define ADC_1st             VIN                               // ADC 1st used channel (CH2)
...
// Channel assignment
#define ADC_CH_1ST          ADC_CHANNEL_4                     // CH4 =  VIN
#define ADC_CH_2ND          ADC_CHANNEL_6                     // CH6 = NTC
#define ADC_CH_3RD          ADC_CHANNEL_8                     // CH8 = IRON TIP
...
#define T12_Cal250        1500
#define T12_Cal400        2400

#define C210_Cal250       800
#define C210_Cal400       1500

#define C245_Cal250       1500
#define C245_Cal400       2400
#endif
...
#define BUZZER_OFF          HAL_GPIO_WritePin(BUZ_GPIO_Port, BUZ_Pin, GPIO_PIN_RESET);        // All pins belong to the same port
#define BUZZER_ON           HAL_GPIO_WritePin(BUZ_GPIO_Port, BUZ_Pin, GPIO_PIN_SET);
#define BUZZER_TOGGLE       HAL_GPIO_TogglePin(BUZ_GPIO_Port, BUZ_Pin);
