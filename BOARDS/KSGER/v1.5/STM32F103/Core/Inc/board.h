...
#define DISPLAY_DEVICE        hspi1                           // SPI / I2C handler if used. Enables HW mode, otherwise SW mode is used (DISPLAY_DEVICE must be defined)
...
#define DISPLAY_START_COLUMN  0                               // Display column offset
