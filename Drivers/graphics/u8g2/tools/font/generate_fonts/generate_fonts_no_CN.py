...
def main():
    ...
    run_command(f"..\\bdfconv\\bdfconv.exe -v -b 0 -f 1 -m \"32-126,160-255,268-271,282-283,286,287,304,305,327,328,344,345,350-353,356,357,366,367,381,382,937,1040-1103,5000-65535\" \"../bdf/font_menu.bdf\" -o {os.path.join(output_dir, 'font_menu_no_CN.c')} -n u8g2_font_menu_no_CN")
    run_command(f"..\\bdfconv\\bdfconv.exe -v -b 0 -f 1 -m \"32-126,160-255,268-271,282-283,286,287,304,305,327,328,344,345,350-353,356,357,366,367,381,382,937,1040-1103,5000-65535\" \"../bdf/font_small.bdf\" -o {os.path.join(output_dir, 'font_small_no_CN.c')} -n u8g2_font_small_no_CN")
    ...
    font_files = [os.path.join(output_dir, "font_iron_temp.c"),
                  os.path.join(output_dir, "font_menu_no_CN.c"),
                  os.path.join(output_dir, "font_small_no_CN.c")]
    combined_font_file = "u8g2_aio_no_CN.c"
