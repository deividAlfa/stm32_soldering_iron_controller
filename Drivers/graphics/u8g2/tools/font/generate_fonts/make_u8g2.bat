...
..\bdfconv\bdfconv.exe -v -b0 -f1 -m "45,48-57,67,70,176" "../bdf/ITC Avant Garde Gothic Medium_31.bdf" -o font_iron_temp.c  -n u8g2_font_iron_temp
copy /b font_menu.c + font_small.c + font_iron_temp.c u8g2_aio.c
