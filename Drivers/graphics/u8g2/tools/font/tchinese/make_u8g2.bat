...
pushd "%SystemDrive%"
mkdir tmp
"%~dp0\..\otf2bdf\otf2bdf.exe" -m "%~dp0\font_menu_cht.map" -p 9 -o "%~dp0\font_menu_cht.bdf" "%~dp0\fireflysung.ttf"
"%~dp0\..\otf2bdf\otf2bdf.exe" -m "%~dp0\font_small_cht.map" -p 8 -o "%~dp0\font_small_cht.bdf" "%~dp0\fireflysung.ttf"
rmdir tmp
popd
