...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_turkish] = {
      .boot_firstBoot = "ilk Onyukleme!",
      .boot_Profile = "Profil",

      .main_error_noIron_Detected = "UC ALGILANMADI",
      .main_error_failsafe = "GUVENLi MOD",
      .main_error_NTC_high = "NTC YUKSEK OKUMA",
      .main_error_NTC_low = "NTC DUSUK OKUMA",
      .main_error_VoltageLow = "VOLTAG DUSUK",
      ...
      .settings_EDIT_TIPS = "UC DUZENLE",
      .settings_CALIBRATION = "KALiBRASYON",
      .settings_EXIT = "CIKIS",

      .IRON_Max_Temp = "Max IsI",
      .IRON_Min_Temp = "Min IsI",
      .IRON_User_Temp = "ilk IsI",
      .IRON_Standby = "Bekleme",
      .IRON_Sleep = "Uyku",
      .IRON_Boost = "Darbe",
      .IRON_Boost_Add = " Arttirmak",
      .IRON_Power = "Güc",
      .IRON_Heater = "Isitici",
      .IRON_ADC_Time = "ADC Zamani",
      .IRON_PWM_mul = "PWM mul.",
      .IRON_No_Iron = "Uc yok",
      .IRON_Error_Timeout = "Hata zamani",
      .IRON_Error_Resume_Mode = " Devam Et",
      .IRON_Filter_Settings = "FiLTRE AYARLARI",

      .FILTER_Filter = "Filtre",
      .FILTER__Threshold = " Esik",
      .FILTER__Count_limit = " Sayi limit",
      .FILTER__Step_down = " Düsürmek",
      .FILTER__Min = " Düsük",
      .FILTER_Reset_limit = "Sifirlandi",
      ...
      .SYSTEM_Wake_Mode = "Uyandirma",
      .SYSTEM_Shake_Filtering = " Filtre",
      .SYSTEM_Stand_Mode = " Stantta",
      .SYSTEM_Boot = "Baslangic",
      .SYSTEM_Button_Wake = "Dume Uyan",
      .SYSTEM_Shake_Wake = "Salla Uyan",
      .SYSTEM_Encoder = "Potans",
      .SYSTEM_Buzzer = "Buzzer",
      .SYSTEM_Temperature = "Sicaklik",
      .SYSTEM__Step = " Adim",
      .SYSTEM__Big_Step = " Byk Adim",
      .SYSTEM_Active_Detection = "K.Yazi",
      .SYSTEM_LVP = "DVK",
      .SYSTEM_Gui_Time = "Gui zamani",
      .SYSTEM_DEBUG = "Geliştirici",
      .SYSTEM_NTC_MENU = "NTC MENU",
      .SYSTEM_RESET_MENU = "SIFIRLA MENU",
      ...
      .RESET_Reset_msg_settings_1 = "SiSTEMi SIFIRLA",
      .RESET_Reset_msg_settings_2 = "AYARLAR?",
      .RESET_Reset_msg_profile_1 = "MEVCUT SIFIRLA",
      .RESET_Reset_msg_profile_2 = "PROFIL?",
      .RESET_Reset_msg_profiles_1 = "HEPSiNi SIFIRLA",
      .RESET_Reset_msg_profiles_2 = "PROFILLER?",
      .RESET_Reset_msg_all_1 = "TUMUNU YAPMAK",
      .RESET_Reset_msg_all_2 = "SiSTEM SIFIRLAMA?",
      ...
      .TIP_SETTINGS_DELETE = "SiL",

      .CAL_ZeroSet = "Sifir seti ",       // Must be 11 chars long
      .CAL_Sampling = "Örnekleme  ",      // Must be 11 chars long
      .CAL_Captured = "Yakalandi  ",      // Must be 11 chars long
      .CAL_Step = "HESAP ADIM:",
      .CAL_Wait = "BEKLE...",
      .CAL_Measured = "OLCULEN:",
      .CAL_Success = "BASARLI!",
      .CAL_Failed = "ARIZALI!",
      .CAL_DELTA_HIGH_1 = "DELTA COK YÜKSEK!",
      .CAL_DELTA_HIGH_2 = "Manuel ayarla",
      .CAL_DELTA_HIGH_3 = "Tekrar dene",
      .CAL_Error = "HATA TESPiTi!",
      .CAL_Aborting = "iptal...",
      ...
      .ERROR_EXCEEDED = "ASILDI",
      .ERROR_UNKNOWN = "BiLiNMEYEN HATA",
      .ERROR_SYSTEM_HALTED = "SiSTEM DURDU",
      .ERROR_BTN_RESET = "DUME iLE SIFIRLA",

      .OffOn =       { "KPLI", "ACIK" },
      .DownUp =      { "ASAGI", "YUKARI" },
      .WakeModes =   { "KPLI", "BKLM", "UYKU", "TUM" },
      .wakeMode =    { "SALLA", "SABiT" },
      .encMode =     { "TERS", "NORMAL" },
      .InitMode =    { "UYKU", "BKLM", "CLS" },
      .dimMode =     { "KPLI", "UYKU", "TUM" },
      .errMode =     { "UYKU", "CLS", "SON" },
    },
};
