...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_tchinese] = {
      ...
      .IRON_smartActiveEnable = "智慧啟動",
      .IRON_smartActiveLoad = "└負載",
      .IRON_Power = "功率限制",
      .IRON_Heater = "烙鐵電阻",
    ...
    [lang_spanish] = {
      .boot_firstBoot = "primer inicio! ",
      .boot_Profile = "Profile",

      .main_error_noIron_Detected = "NO CAUTIN DETECTEDA",
      .main_error_failsafe = "FAILSAFE MODE",
      .main_error_NTC_high = "NTC READ HIGH",
      .main_error_NTC_low = "NTC READ LOW",
      .main_error_VoltageLow = "VOLTAGE LOW",
      ...
      .settings_IRON = "CAUTIN",
      .settings_SYSTEM = "SISTEMA",
      .settings_DEBUG = "DEBUG",
      .settings_EDIT_TIPS = "EDIT TIPS",
      .settings_CALIBRATION = "CALIBRACION",
      .settings_EXIT = "SALIDA",
#ifdef ENABLE_ADDONS
      .settings_ADDONS = "ADDONS/EXTRAS",
#endif
      ...
      .IRON_smartActiveLoad = " LOAD",
      .IRON_Power = "Poder",
      .IRON_Heater = "calefacion",
      .IRON_ADC_Time = "ADC Tiempo",
      .IRON_PWM_mul = "PWM mul.",
      .IRON_No_Iron = "No cautin",
      .IRON_Error_Timeout = "Err tiempo",
      .IRON_Error_Resume_Mode = " Resumir",
      .IRON_FILTER_MENU = "FILTRO MENU",
      .IRON_NTC_MENU = "NTC MENU",

      .FILTER_Filter = "Filtro",
      .FILTER__Threshold = " Threshold",
      .FILTER__Count_limit = " Count limit",
      .FILTER__Step_down = " Paso bajo",
      .FILTER__Min = " Min",
      .FILTER_Reset_limit = "Resetear limita",

      .SYSTEM_Profile = "Perfil",
      .SYSTEM_Boot = "inicio",
      .SYSTEM_Button_Wake = "Btn wake",
      .SYSTEM_Shake_Wake = "Shake wake",
      .SYSTEM_Encoder = "Encoder",
      ...
      .SYSTEM_Temperature = "Temperature",
      .SYSTEM__Step = " Paso",
      .SYSTEM__Big_Step = " Grande  paso",
      .SYSTEM_Active_Detection = "Active det.",
      .SYSTEM_LVP = "LVP",
      .SYSTEM_Gui_Time = "Gui tiempo",
      .SYSTEM_DEBUG = "DEBUG",
      .SYSTEM_CLONE_FIX = "Clone fix",
      .SYSTEM_RESET_MENU = "RESETEAR MENU",
      .SYSTEM_Remember = "Recordar ultimo",
      .SYSTEM_RememberLastProfile = " Perfile",
      .SYSTEM_RememberLastTip = " Sel. tip",
#ifdef HAS_BATTERY
      .SYSTEM_RememberLastTemp = " Set temp",
#endif

      .SYSTEM_DISPLAY_MENU = "PANTALLA",
#ifndef ST756
      .DISPLAY_ContrastOrBrightness = " Brillo",
#else
      .DISPLAY_ContrastOrBrightness = "Contraste",
#endif
      .DISPLAY_Offset = "Offset",
      .DISPLAY_Xflip = "X flip",
      .DISPLAY_Yflip = "Y flip",
      .DISPLAY_Ratio = "Ratio",
      .DISPLAY_Dim = "Dimmer",
      .DISPLAY_Dim_inSleep = " En reposo",
      .DISPLAY_Advanced = "AVANZADO",

      .NTC_Enable_NTC = "Enable NTC",
      .NTC_Pull = "Pull",
      .NTC__Res = " Res",
      .NTC__Beta = " Beta",
      .NTC_NTC_Detect = "NTC Detectado",
      .NTC__High = " Alto",
      .NTC__Low = " Bajo",

      .RESET_Reset_Settings = "Resetear config",
      .RESET_Reset_Profile = "Resetear Perfile",
      .RESET_Reset_Profiles = "Resetear Perfiles",
      .RESET_Reset_All = "Resetear Todo",
      .RESET_Reset_msg_settings_1 = "RESETEAR SISTEMA",
      .RESET_Reset_msg_settings_2 = "CONFIGURACION?",
      .RESET_Reset_msg_profile_1 = "RESET CURRENT",
      .RESET_Reset_msg_profile_2 = "PERFILE?",
      .RESET_Reset_msg_profiles_1 = "RESET TODO",
      .RESET_Reset_msg_profiles_2 = "PERFILES?",
      .RESET_Reset_msg_all_1 = "PERFORM FULL",
      .RESET_Reset_msg_all_2 = "SISTEMA RESET?",

      .TIP_SETTINGS_Name = "Nombre",
      .TIP_SETTINGS_PID_kp = "PID Kp",
      .TIP_SETTINGS_PID_ki = "PID Ki",
      .TIP_SETTINGS_PID_kd = "PID Kd",
      .TIP_SETTINGS_PID_Imax = "PID Imax",
      .TIP_SETTINGS_PID_Imin = "PID Imin",
      .TIP_SETTINGS_COPY = "COPIAR",
      .TIP_SETTINGS_DELETE = "BORRAR",
      ...
      .CAL_Success = "SUCCESO!",
      .CAL_Failed = "FALLIDO!",
      .CAL_DELTA_HIGH_1 = "DELTA ALTO!",
      .CAL_DELTA_HIGH_2 = "Adjust a mano",
      .CAL_DELTA_HIGH_3 = "Probar de nuevo",
      .CAL_Error = "ERROR DETECTADA!",
      .CAL_Aborting = "Cancelar...",
      ...
      ._ADD_NEW = "AÑADIR NUEVO",

      .ERROR_RUNAWAY = "TEMP A FUERA ",
      .ERROR_EXCEEDED = "TEMP EXCEDIDA",
      .ERROR_UNKNOWN = "ERROR DESCONOCIDO",
      .ERROR_SYSTEM_HALTED = "SYSTEMA PARADA",
      .ERROR_BTN_RESET = "Use btn to reset",
